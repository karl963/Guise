...
<html manifest="cache.manifest" lang="et">
  ...
  <body>
	...
	<div id="Kogu">
		...
		<div id="PÃƒÂ¤is" class="VasakMenuList">
		...
		<div id="VasakMenu" class="VasakMenuList" >
			...
			<!--<li class="tab"><a href="#sisuHaaleta"><input type="image" id="HÃ¤Ã¤leta" class="leftMenuButton" src="pildid/Haaleta.png" /></a></li>-->
		...
		<div id="sisuOtsiKandidaati" class="content sisu">
			...
			<table class="minukontoLabel">
				...
				<tr>
					...
					<td class="minukontoNupp"><input id="PIIRKOND" type="text" name="SÃƒÂ¼nniaeg" class="otsinguLahter" onFocus="this.className= 'otsinguLahterOnFocus'" onBlur="this.className= 'otsinguLahterOnBlur'"></td>
